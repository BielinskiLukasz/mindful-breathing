...
1. **Single-file apps need smoke-test passes after each plan, not just at milestone close** — v0.5 caught nothing post-ship; v0.6 had 3. The pattern is emerging.
2. **Well-scoped requirements produce fast execution** — v0.5 averaged ~8 plans; v0.6 averaged 1.5 plans with equal feature density. Fewer, more focused plans win.
