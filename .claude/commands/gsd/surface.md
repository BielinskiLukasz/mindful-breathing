...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Users/lukasz.bielinski/projects/mindful-breathing/.claude/.gsd-surface.json`
(sibling to `C:/Users/lukasz.bielinski/projects/mindful-breathing/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Users/lukasz.bielinski/projects/mindful-breathing/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`C:/Users/lukasz.bielinski/projects/mindful-breathing/.claude/skills`).
...
`C:/Users/lukasz.bielinski/projects/mindful-breathing/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/Users/lukasz.bielinski/projects/mindful-breathing/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Users/lukasz.bielinski/projects/mindful-breathing/.claude/.gsd-surface.json`
Install profile marker: `C:/Users/lukasz.bielinski/projects/mindful-breathing/.claude/.gsd-profile`
Skill dirs: `C:/Users/lukasz.bielinski/projects/mindful-breathing/.claude/skills/gsd-*/`
Engine module: `C:/Users/lukasz.bielinski/projects/mindful-breathing/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `C:/Users/lukasz.bielinski/projects/mindful-breathing/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
