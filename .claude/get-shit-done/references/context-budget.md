...
The keys live in `.claude/settings.json` (project) or `C:/Users/lukasz.bielinski/projects/mindful-breathing/.claude/settings.json` (global) — **not** in `.planning/config.json`:
